...
async function seed() {
  ...
  const users = await Promise.all([
    ...
    user.create({email: 'jerukim@email.com', password: '123', isAdmin: true})
  ])
  ...
  const Products = await Promise.all([
    products.create({
      name: 'Bear Mask',
      imageUrl:
        'https://postfiles.pstatic.net/20160324_171/smr0077_1458823643640DbfXw_JPEG/PIQ0116S0260_pz_a001.jpg?type=w3',
    ...
    products.create({
      name: 'Christmas Mask',
      imageUrl:
        'https://postfiles.pstatic.net/20151213_72/gawon10201_14500146882475pDAA_JPEG/SAM_1893.JPG?type=w1',
    ...
    products.create({
      name: 'Flower mask',
      imageUrl:
        'https://postfiles.pstatic.net/MjAxODA0MDRfMTEw/MDAxNTIyODQzMjg5MTYz.OP8ya4h-YCCHxE4fqjM8nVs_mwTtAozLguZHmMZAsAgg.UmeF53bwWbWvdxO2Xz6td4MS58a8bKdiPDQ7jg-NBUcg.JPEG.boochouclab/IMG_0987-2.jpg?type=w1',
    ...
    products.create({
      name: 'Black Mask',
      imageUrl:
        'https://postfiles.pstatic.net/MjAxODAxMTZfMTEg/MDAxNTE2MDMwMDA3NTg3.7Kt0M7JcnJ7tZd8uMN7F6rz0KlrGgsYO7MGw9XVgl_Mg.tV74N88MHv01IbfWmq4i4YQW-yqJY_sRFAtHaY76fFog.PNG.bmw850307/%EB%B9%85%EB%B1%85%EC%8A%B9%EB%A6%AC.png?type=w773',
    ...
    products.create({
      ...
      imageUrl:
        'http://shop1.daumcdn.net/thumb/R500x500/?fname=http%3A%2F%2Fshop1.daumcdn.net%2Fshophow%2Fp%2FB4048086814.jpg%3Fut%3D20171109124044',
      description:
    ...
    products.create({
      name: 'Celeb Mask',
      imageUrl:
        'http://gdimg.gmarket.co.kr/1474908105/still/600?ver=1533540687',
      description:
        'It made by new material, protect from air dust, pollution.  It can be re-use more than 3',
      quantity: 80,
      price: 440
    }),
    products.create({
    ...
    products.create({
      ...
      imageUrl:
        'http://www.epanchok.co.kr/shop_images/ga/a/16/1416651536574550_l.jpg',
      description:
        'You will enjoy the famouse Line charactors.  It will perfectly protect from air dust as well',
      quantity: 116,
      price: 1170
    }),
    products.create({
      ...
      imageUrl:
        'http://www.epanchok.co.kr/shop_images/ga/a/16/1374291526536576_l.jpg',
      description:
        'First created by Fullseed, it is solid model to keep comfortable and fit on to your face',
      quantity: 10,
      price: 1750
    }),
    products.create({
      ...
      imageUrl:
        'http://www.epanchok.co.kr/shop_images/ga/a/16/1330981517533359_l.jpg',
    ...
    products.create({
      name: 'Kids Dust Mask',
      imageUrl:
        'http://www.epanchok.co.kr/shop_images/ga/a/16/1330991517533378_l.jpg',
    ...
    products.create({
      ...
      imageUrl:
        'http://www.epanchok.co.kr/shop_images/ga/a/16/1326441517018639_l.jpg',
      description:
        'Winter kingdom pattron color.  3 filters make keep out dust perfectly',
      quantity: 2,
      price: 1040
    }),
    products.create({
    ...
    products.create({
      ...
      imageUrl:
        'http://image.gsshop.com/mi09/deal/dealno/314/201879183541013.jpg',
    ...
    products.create({
      ...
      description:
        'Red LED and IR RED will give your skin more tension and young',
      quantity: 34,
      price: 20034
    }),
    products.create({
